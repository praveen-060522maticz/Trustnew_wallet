                                                ...
                                                <View style={style.tabcontent}>
                                                                    ...
                                                                    <View style={style.listsec}>
                                                                        ...
                                                                        <View>
                                                                            ...
                                                                            {/* {item?.tokenType !== "TRC20" ?
                                                                                <Text style={style.listtotal}>{(item.balance)?.toFixed(6)} {item?.currencyName}</Text>
                                                                                :
                                                                                <Text style={style.listtotal}>{(updatebalance)?.toFixed(6)} {item?.currencyName}</Text>
                                                                            } */}
                                                                        </View>
                                                                    </View>
                                                    ...
                                                    {/* <TouchableOpacity
                                                            ...
                                                            style={{
                                                                ...
                                                                // marginTop: "10%",
                                                                padding: "3%",
                                                                alignItems: "center", backgroundColor: theme.background, borderRadius: borderradius * 0.5, justifyContent: "center", alignSelf: "center", borderWidth: 1.5, borderColor: theme.theme == "dark" ? "#224969" : "#00001C"
                                                            }}>
