...
export default function Recievewallet({ navigation }) {
                    ...
                    {filterdata?.length == 0 ?
                        ...
                        <Card style={style.card_container} >
                            <ScrollView showsVerticalScrollIndicator={false} >
                                ...
                                {filterdata.map((item) =>
                                    <TouchableOpacity
                                        onPress={() => navigation.navigate('Receivecurrency', { data: item })}>
                                        <View style={style.coinlistsec}>
                                            ...
                                            <View>
                                                <Text style={style.parablue}>{Number(item.balance).toFixed(4)} {item.symbol}</Text>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
                                )
